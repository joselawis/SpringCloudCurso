package com.lawis.springcloud.msvc.oauth.security;
    ...
    SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http)
        ...
        http.securityMatcher(authorizationServerConfigurer.getEndpointsMatcher())
                .with(authorizationServerConfigurer,
                        authorizationServer -> authorizationServer.oidc(Customizer.withDefaults()) // Enable OpenID
                                                                                                   // Connect 1.0
    ...
    OAuth2TokenCustomizer<JwtEncodingContext> tokenCustomizer() {
        return context -> {
            if (context.getTokenType().getValue().equals(OAuth2TokenType.ACCESS_TOKEN.getValue())) {
                ...
                context.getClaims()
                        .claim("data", "Aditional data for the token")
